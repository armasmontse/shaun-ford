...
function cltvo_js(){
	wp_register_script( 'cltvo_functions_js', JSPATH.'functions.js', array('jquery', 'cltvo_swiper_js', 'cltvo_nanoscroller_js', 'cltvo_validate_js'/*'cltvo_scrollIt_js', 'cltvo_validate_espanol_js'*/), false, true );

	wp_register_script( 'cltvo_swiper_js', JSPATH.'vendor/swiper.jquery.min.js', array('jquery'), false, true );
	wp_register_script( 'cltvo_nanoscroller_js', JSPATH.'vendor/nanoscroller.jquery.min.js', array('jquery'), false, true );
    wp_register_script( 'cltvo_validate_js', JSPATH.'vendor/jquery.validate.min.js', array('jquery'), false, true );
