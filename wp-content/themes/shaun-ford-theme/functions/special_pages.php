...
$special_pages = array(
    ...
    'contact' => array(
        'Contact',  // nombre de la pagina
        ""  // slug de de la pagina padre siempre se debe registar la pagina padre
    ),
    'home' => array(
        'Home',  // nombre de la pagina
        ""  // slug de de la pagina padre siempre se debe registar la pagina padre
    ),
    'home-vertical' => array(
        'Home vertical',  // nombre de la pagina
        "home"  // slug de de la pagina padre siempre se debe registar la pagina padre
    ),
    'home-horizontal' => array(
        'Home horizonal',  // nombre de la pagina
        "home"  // slug de de la pagina padre siempre se debe registar la pagina padre
    ),
    'services' => array(
        'Services',  // nombre de la pagina
        ""  // slug de de la pagina padre siempre se debe registar la pagina padre
    ),
    'showroom' => array(
        'Showroom',  // nombre de la pagina
        ""  // slug de de la pagina padre siempre se debe registar la pagina padre
    ),
    'projects' => array(
        'Projects',  // nombre de la pagina
        ""  // slug de de la pagina padre siempre se debe registar la pagina padre
    ),
    'products' => array(
        'Products',  // nombre de la pagina
        ""  // slug de de la pagina padre siempre se debe registar la pagina padre
    ),
    'careers' => array(
        'Careers',  // nombre de la pagina
        ""  // slug de de la pagina padre siempre se debe registar la pagina padre
    ),
    'journal' => array(
        'Journal',  // nombre de la pagina
        ""  // slug de de la pagina padre siempre se debe registar la pagina padre
    ),
    'archive' => array(
        'Archive',  // nombre de la pagina
        "journal"  // slug de de la pagina padre siempre se debe registar la pagina padre
    )
);
